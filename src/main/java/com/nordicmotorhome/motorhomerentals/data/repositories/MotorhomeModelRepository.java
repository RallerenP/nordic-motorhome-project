...
public class MotorhomeModelRepository implements IRepository<MotorhomeModelEntity> {
    ...
    @Override
    public List<MotorhomeModelEntity> findAll(String key, String value) throws NoSuchEntityException {
        try {
            Connection con = DBManager.getConnection();
            String SQL = "SELECT * FROM motorhome_models WHERE " + key + " = ?";
            PreparedStatement ps = con.prepareStatement(SQL);
            ...
            ArrayList<MotorhomeModelEntity> entities = new ArrayList<>();
    ...
    @Override
    public List<MotorhomeModelEntity> findAll(String key, int value) throws NoSuchEntityException {
        try {
            Connection con = DBManager.getConnection();
            String SQL = "SELECT * FROM motorhome_models WHERE " + key + " = ?";
            PreparedStatement ps = con.prepareStatement(SQL);
